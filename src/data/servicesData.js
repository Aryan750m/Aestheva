export const servicesData = [
  ...
  },
  {
    ...
    imageUrl: new URL('../assets/acne management.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 mins",
      downtime: "None",
  ...
  },
  {
    ...
    category: "skin",
    iconName: "Layers",
    imageUrl: new URL('../assets/darkspotsfreckles.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 - 60 mins",
  ...
  },
  {
    ...
    imageUrl: new URL('../assets/anti aging.webp', import.meta.url).href,
    sessionInfo: {
      duration: "60 mins",
  ...
  },
  {
    ...
    category: "aesthetic",
    iconName: "Droplet",
    imageUrl: new URL('../assets/glutathioneivdrip.webp', import.meta.url).href,
    sessionInfo: {
      duration: "30 mins",
      downtime: "None",
  ...
  },
  {
    ...
    category: "aesthetic",
    iconName: "Smile",
    imageUrl: new URL('../assets/facelift.webp', import.meta.url).href,
    sessionInfo: {
      duration: "60 - 90 mins",
      downtime: "None",
  ...
  },
  {
    ...
    category: "aesthetic",
    iconName: "Zap",
    imageUrl: new URL('../assets/exosomesforskin.webp', import.meta.url).href,
    sessionInfo: {
      duration: "60 mins",
  ...
  // ==================== CHEMICAL PEEL ====================
  {
    ...
    category: "skin",
    iconName: "Sparkles",
    imageUrl: new URL('../assets/chemicalpeel.webp', import.meta.url).href,
    sessionInfo: {
      duration: "30 mins",
  ...
  // ==================== HAIR TREATMENTS ====================
  {
    ...
    category: "hair",
    iconName: "Activity",
    imageUrl: new URL('../assets/PRPGFCTherapy.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 mins",
  ...
  },
  {
    ...
    category: "skin",
    iconName: "Grid",
    imageUrl: new URL('../assets/microneedling.webp', import.meta.url).href,
    sessionInfo: {
      duration: "60 mins",
  ...
  },
  {
    ...
    category: "skin",
    iconName: "Sparkles",
    imageUrl: new URL('../assets/mesotherapy.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 mins",
  ...
  },
  {
    ...
    category: "skin",
    iconName: "Sparkles",
    imageUrl: new URL('../assets/skinbrightening.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 mins",
      downtime: "None",
      sessions: "4 - 6 sessions",
  ...
  },
  {
    ...
    category: "hair",
    iconName: "TrendingUp",
    imageUrl: new URL('../assets/hairfallalopecia.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 - 60 mins",
      downtime: "None",
  ...
  },
  {
    ...
    category: "hair",
    iconName: "Activity",
    imageUrl: new URL('../assets/dandruff.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 mins",
      downtime: "None",
      sessions: "3 - 5 sessions",
  ...
  },
  {
    ...
    category: "hair",
    iconName: "Zap",
    imageUrl: new URL('../assets/exsosomesforhair.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 mins",
  ...
  // ==================== LASER TREATMENTS ====================
  {
    ...
    category: "laser",
    iconName: "Flame",
    imageUrl: new URL('../assets/laserhairremoval.webp', import.meta.url).href,
    sessionInfo: {
  ...
  },
  {
    ...
    category: "laser",
    iconName: "Zap",
    imageUrl: new URL('../assets/photorejuvenationcarbonlaser.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 mins",
      downtime: "None",
      sessions: "3 - 5 sessions",
  ...
  },
  {
    ...
    category: "laser",
    iconName: "Trash2",
    imageUrl: new URL('../assets/tattooremoval.webp', import.meta.url).href,
    sessionInfo: {
      duration: "15 - 45 mins",
  ...
  },
  {
    ...
    category: "laser",
    iconName: "Scissors",
    imageUrl: new URL('../assets/skintagsmoleremoval.webp', import.meta.url).href,
    sessionInfo: {
      duration: "15 - 30 mins",
  ...
  },
  {
    ...
    category: "laser",
    iconName: "Flame",
    imageUrl: new URL('../assets/lasertreatments.webp', import.meta.url).href,
    sessionInfo: {
      duration: "30 - 60 mins",
  ...
  },
  {
    ...
    category: "laser",
    iconName: "Scissors",
    imageUrl: new URL('../assets/scarreduction.webp', import.meta.url).href,
    sessionInfo: {
      duration: "45 - 60 mins",
